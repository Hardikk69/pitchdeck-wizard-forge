...
const ScrollStack: React.FC<ScrollStackProps> = ({
  cards,
  backgroundColor = "bg-white", // Changed default to "bg-background"
  cardHeight = "60vh",
  ...
  const cardCount = Math.min(cards.length, 7);
  ...
  return (
    <section
      ...
      className="relative max-h-screen w-full lg:w-[100%] overflow-y-scroll [&::-webkit-scrollbar]:hidden scrollbar-hide">
      <div
        ref={sectionRef}
